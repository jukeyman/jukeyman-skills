...
This skill defines the autonomous behavior, system prompt, and capabilities for the agent **openai agents**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/apify/apify-docs-master/sources/platform/integrations/ai/openai_agents.md`
