---
name: agent_skills_spec
description: agent skills spec
---

# agent skills spec

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **agent skills spec**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_KNOWLEDGE-BASE/legal-reference/credit-laws/Laws/skills/official-anthropic-skills/agent_skills_spec.md`
