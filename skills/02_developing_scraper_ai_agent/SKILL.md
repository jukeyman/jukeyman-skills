---
name: 02_developing_scraper_ai_agent
description: 02 developing scraper ai agent
---

# 02 developing scraper ai agent

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **02 developing scraper ai agent**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/apify/apify-docs-master/sources/academy/platform/scraping_with_apify_and_ai/02_developing_scraper_ai_agent.md`
