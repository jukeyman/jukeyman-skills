---
name: ide-companion-spec
description: ide-companion-spec
---

# ide-companion-spec

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **ide-companion-spec**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/gemini-cli-main/docs/ide-integration/ide-companion-spec.md`
