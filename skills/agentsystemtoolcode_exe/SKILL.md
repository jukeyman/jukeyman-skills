---
name: agentsystemtoolcode_exe
description: agent.system.tool.code exe
---

# agent.system.tool.code exe

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **agent.system.tool.code exe**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/agent-zero/prompts/agent.system.tool.code_exe.md`
