---
name: 04_tests_driven_prompting
description: 04 tests driven prompting
---

# 04 tests driven prompting

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **04 tests driven prompting**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/apify/apify-docs-master/sources/academy/platform/scraping_with_apify_and_ai/04_tests_driven_prompting.md`
