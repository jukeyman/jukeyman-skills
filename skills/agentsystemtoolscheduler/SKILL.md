---
name: agentsystemtoolscheduler
description: agent.system.tool.scheduler
---

# agent.system.tool.scheduler

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **agent.system.tool.scheduler**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/agent-zero/prompts/agent.system.tool.scheduler.md`
