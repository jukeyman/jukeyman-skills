...
description: contributing-skills
---

# contributing-skills

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **contributing-skills**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/agent-zero/docs/developer/contributing-skills.md`
