---
name: agentsystemtoolskills
description: agent.system.tool.skills
---

# agent.system.tool.skills

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **agent.system.tool.skills**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/agent-zero/prompts/agent.system.tool.skills.md`
