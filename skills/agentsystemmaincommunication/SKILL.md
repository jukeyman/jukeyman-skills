---
name: agentsystemmaincommunication
description: agent.system.main.communication
---

# agent.system.main.communication

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **agent.system.main.communication**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/agent-zero/agents/developer/prompts/agent.system.main.communication.md`
