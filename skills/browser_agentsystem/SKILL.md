---
name: browser_agentsystem
description: browser agent.system
---

# browser agent.system

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **browser agent.system**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/agent-zero/prompts/browser_agent.system.md`
