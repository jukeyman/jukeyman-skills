...
This skill defines the autonomous behavior, system prompt, and capabilities for the agent **system-prompt**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/gemini-cli-main/docs/cli/system-prompt.md`
