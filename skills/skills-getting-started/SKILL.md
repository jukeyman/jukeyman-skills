---
name: skills-getting-started
description: skills-getting-started
---

# skills-getting-started

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **skills-getting-started**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/gemini-cli-main/docs/cli/tutorials/skills-getting-started.md`
