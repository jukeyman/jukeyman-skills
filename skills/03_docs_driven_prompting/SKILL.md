---
name: 03_docs_driven_prompting
description: 03 docs driven prompting
---

# 03 docs driven prompting

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **03 docs driven prompting**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/apify/apify-docs-master/sources/academy/platform/scraping_with_apify_and_ai/03_docs_driven_prompting.md`
