---
name: agentsystemtoolmemory
description: agent.system.tool.memory
---

# agent.system.tool.memory

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **agent.system.tool.memory**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/agent-zero/prompts/agent.system.tool.memory.md`
