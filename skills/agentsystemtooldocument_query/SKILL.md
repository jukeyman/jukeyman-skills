---
name: agentsystemtooldocument_query
description: agent.system.tool.document query
---

# agent.system.tool.document query

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **agent.system.tool.document query**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/agent-zero/prompts/agent.system.tool.document_query.md`
