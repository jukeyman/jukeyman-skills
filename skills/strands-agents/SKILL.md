---
name: strands-agents
description: strands-agents
---

# strands-agents

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **strands-agents**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/apify/apify-docs-master/sources/platform/integrations/ai/strands-agents.md`
