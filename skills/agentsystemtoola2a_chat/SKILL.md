---
name: agentsystemtoola2a_chat
description: agent.system.tool.a2a chat
---

# agent.system.tool.a2a chat

This skill defines the autonomous behavior, system prompt, and capabilities for the agent **agent.system.tool.a2a chat**.

## Source Location
Originally discovered in Rick's Downloads at: `/Users/kalivibecoding/Downloads/_RECENT-PROJECTS/ai-systems/agent-zero/prompts/agent.system.tool.a2a_chat.md`
